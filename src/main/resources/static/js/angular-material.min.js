        ...
        function e(e, n) {
            ...
            function g(e, o, r, a) {
                ...
                for (var d = u(o);;) {
                    ...
                    var c = d + (e ? -1 : 1),
                        s = null;
                    if (i(c) ? s = v[c] : n && (s = e ? f() : h(), c = u(s)), null === s || c === a)
                        return null;
                    if (r(s))
                        return s;
            ...
            function l(n, o, r) {
                ...
                return n.forEach(function(n) {
                        ...
                        for (var d in e.MEDIA)
                            a = m(o, n + "-" + d), t.isDefined(o[a]) && i.push(o.$observe(a, t.bind(void 0, r, d)))
                    }),
                    function() {
            ...
            var h = s.startSymbol(),
                ...
                v = {
                    ...
                    disableScrollAround: function(e, n) {
                        ...
                        if (v.disableScrollAround._count = v.disableScrollAround._count || 0, ++v.disableScrollAround._count, v.disableScrollAround._enableScrolling)
                            return v.disableScrollAround._enableScrolling;
                        e = t.element(e);
                        var d = o[0].body,
                            c = i(),
                            s = r(n);
                    ...
                    getClosest: function(e, n, o) {
                        if (e instanceof t.element && (e = e[0]), n = n.toUpperCase(), o && (e = e.parentNode), !e)
                            return null;
                        do
                            if (e.nodeName === n)
                                return e;
    ...
    function() {
        ...
        function a(e, n) {
            ...
            function i(e, t) {
                var o;
                for (var r in h)
                    o = h[r], o instanceof n && ("start" === e && o.cancel(), o[e](t, u))
            }
            ...
            function o(e, o, r, i, a, d, c, s, l, m, u) {
                return function() {
                    ...
                    function h(e, t) {
                        ...
                        if (t.closeTo !== n)
                            return o.all($.splice(t.closeTo).map(r));
                        var a = $.pop();
                        return r(a)
                    }
                ...
                o.name = e, o.colors = {}, o.dark = n, n(!1), M.forEach(function(e) {
                    ...
                    o[e + "Palette"] = function(r, i) {
                        ...
                        return Object.keys(a.hues).forEach(function(e) {
                            ...
                            if (-1 == k.indexOf(t))
                                throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", t).replace("%2", o.name).replace("%3", e).replace("%4", r).replace("%5", k.join(", ")))
                        }), o
                    }, o[e + "Color"] = function() {
            ...
            function n(e, n) {
                ...
                "string" == typeof r && (r = r.split(" ")), "string" == typeof i && (i = i.split(" ")), "string" == typeof a && (a = a.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, t.forEach(e, function(n, d) {
                    ...
                    if (!t.isObject(n)) {
                        var l = s(n);
                        if (!l)
                            throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1", n).replace("%2", e.name).replace("%3", d));
                        e[d] = {
                            value: l,
                            contrast: c()
                        }
            ...
            n.$inject = ["$element", "$attrs", "$scope", "$animate", "$q", "$mdConstant", "$mdTheming", "$$mdDateUtil", "$mdDateLocale", "$mdInkRipple", "$mdUtil"], n.prototype.configureNgModel = function(e) {
                ...
                this.$scope.$apply(function() {
                    if (e.which == t.keyCode.ESCAPE || e.which == t.keyCode.TAB)
                        return t.$scope.$emit("md-calendar-close"), void(e.which == t.keyCode.TAB && e.preventDefault());
                    if (e.which === t.keyCode.ENTER)
                        return t.setNgModelValue(t.displayDate), void e.preventDefault();
            ...
            n.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], n.prototype.generateContent = function() {
                ...
                if (n.tabIndex = -1, n.classList.add("md-calendar-date"), n.setAttribute("role", "gridcell"), e) {
                    ...
                    if (this.isDateEnabled(e)) {
                        ...
                        n.classList.add("md-calendar-date-disabled"), n.textContent = i
                }
                return n
                ...
                if (l.classList.add("md-calendar-month-label"), this.calendarCtrl.maxDate && n > this.calendarCtrl.maxDate && l.classList.add("md-calendar-month-label-disabled"), l.textContent = this.dateLocale.monthHeaderFormatter(t), 2 >= o) {
                    ...
                    if (m.appendChild(l), i.insertBefore(m, d), c)
                        return i
                } else
                    s = 2, l.setAttribute("colspan", "2"), d.appendChild(l);
                for (var u = s; o > u; u++)
    ...
    function() {
        ...
        function o(e) {
            ...
            function r(e, o, r, d, c, s, l, m, u, p) {
                function h(e, t, n, o) {
                    if (o) {
                        if (o.mdHtmlContent = o.htmlContent || n.htmlContent || "", o.mdTextContent = o.textContent || n.textContent || o.content || n.content || "", o.mdHtmlContent && !p.has("$sanitize"))
                    ...
                    function n(e) {
                        for (; e.parentNode;) {
                            ...
                            for (var t = e.parentNode.children, r = 0; r < t.length; r++)
                                e === t[r] || k(t[r], ["SCRIPT", "STYLE"]) || t[r].setAttribute("aria-hidden", o);
                            n(e = e.parentNode)
                        }
                    }
                    var o = !0;
            ...
            function a(n, a, d, c) {
                function s() {
                    for (var e in o.MEDIA)
                        i(e), i.getQuery(o.MEDIA[e]).addListener(C);
            ...
            function r(e, t) {
                function n(t, n) {
                    ...
                    for (var a = 0, l = 0; l - a < t.col;)
                        d >= e ? o() : (a = s.indexOf(0, d), -1 !== a && -1 !== (l = i(a + 1)) ? d = l + 1 : (a = l = 0, o()));
    ...
    function() {
        ...
        function r(e, n, o, r) {
            function i(i, a, d, c) {
                ...
                if (p) {
                    if ("hidden" === d.type)
                        return void a.attr("aria-hidden", "true");
                    if (p.input)
        ...
        function n(e, n, o, r) {
            ...
            return {
                ...
                compile: function(a, d) {
                    ...
                    function s(e) {
                        if ("div" == e)
                            $ = t.element('<div class="_md-no-style _md-list-item-inner">'), $.append(a.contents()), a.addClass("_md-proxy-focus");
                        else {
                    ...
                    var b, v, E = a[0].querySelectorAll(".md-secondary"),
                        $ = a;
                    if (a[0].setAttribute("role", "listitem"), d.ngClick || d.ngHref || d.href || d.uiSref || d.ngAttrUiSref)
                        s("button");
                    else {
                ...
                return h = o.supplant(h, [p, a.html()]), a.empty().append(s), a.append(h), c.tabindex || c.$set("tabindex", 0),
                    function(a, c, s, l) {
                        ...
                        A.$render = function() {
                            ...
                            if (C.setIsPlaceholder(!e), s.mdSelectedText)
                                e = d(s.mdSelectedText)(a);
                            else {
            ...
            function o(e, o, s, l, m, u, p, h, f) {
                ...
                function b(r, i, a) {
                    ...
                    function v(e, n) {
                        ...
                        if (!n.target)
                            throw new Error(s.supplant($, [n.target]));
                        t.extend(n, {
                            isRemoved: !1,
            ...
            function P(e) {
                switch (e.keyCode) {
                    ...
                    case c.KEY_CODE.UP_ARROW:
                        ...
                        break;
                    case c.KEY_CODE.TAB:
                        if (T(), se.hidden || se.loading || se.index < 0 || se.matches.length < 1)
                            return;
                        Z(se.index);
                        break;
                    case c.KEY_CODE.ENTER:
                        if (se.hidden || se.loading || se.index < 0 || se.matches.length < 1)
                            return;
                        if (Y())
                            return;
            ...
            if (!(this.hasAutocomplete && e.isDefaultPrevented && e.isDefaultPrevented())) {
                ...
                if ((!this.separatorKeys || this.separatorKeys.length < 1) && (this.separatorKeys = [this.$mdConstant.KEY_CODE.ENTER]), -1 !== this.separatorKeys.indexOf(e.keyCode)) {
                    if (this.hasAutocomplete && this.requireMatch || !t)
                        return;
                    if (e.preventDefault(), this.hasMaxChipsReached())
                        return;
    ...
    function() {
        ...
        e.$inject = ["$scope", "$rootScope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], e.prototype.init = function() {
            ...
            for (var e = this.getMenus(), t = 0; t < e.length; ++t)
                if (e[t].classList.contains("_md-open"))
                    return t;
            return -1
        }
    }(),
                ...
                if (!u.isAlreadyOpening) {
                    ...
                    p = d(function() {
                        if (n && (n = t.element(n).controller("mdMenu")), u.currentlyOpenMenu && u.currentlyOpenMenu != n) {
                            ...
                            n && !n.isOpen && n.open && (u.isAlreadyOpening = !0, n.open())
                    }, n ? 100 : 250);
    ...
    function() {
        function e(e) {
            function o(n) {
                n.addClass("md-menu");
                var o = n.children()[0];
                if (o.hasAttribute("ng-click") || (o = o.querySelector("[ng-click],[ng-mouseenter]") || o), !o || "MD-BUTTON" != o.nodeName && "BUTTON" != o.nodeName || o.hasAttribute("type") || o.setAttribute("type", "button"), 2 != n.children().length)
        ...
        function e(e, n, o, r, i, a, d) {
            function c(d, c, l) {
                ...
                r(c), d.mdMode === g && v(), d.$watchGroup(["value", "mdMode"], function(e, t) {
                    var n = e[1];
                    if (n !== f && n !== g && (n = g, l.$set("mdMode", n)), n === g)
                        v();
                    else {
                        var o = m(e[0]);
    ...
    function() {
        function e(e, o, r, i, a, d, c, s, l, m) {
            ...
            function V(e) {
                ...
                for (t = 0; o >= t; t++) {
                    if (n = se.tabs[e + t], n && n.scope.disabled !== !0)
                        return n.getIndex();
                    if (n = se.tabs[e - t], n && n.scope.disabled !== !0)
                        return n.getIndex()
                }
            ...
            function ie() {
                if (!me.tabs[se.selectedIndex])
                    return void t.element(me.inkBar).css({
                        left: "auto",
                        right: "auto"
                    });
                if (!se.tabs.length)
                    return ue.push(se.updateInkBarStyles);
            ...
            function de(e) {
                if (!me.tabs.length || !se.shouldPaginate)
                    return 0;
